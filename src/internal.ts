/**
 * clawforce/internal — Explicit internal barrel
 *
 * This surface is intentionally broad and unstable compared to the SDK.
 * The published package maps `clawforce/internal` here. Use the SDK entry
 * (`clawforce`) unless you explicitly need low-level hooks.
 */
...
export { syncGlobalAgents, setAgentsForDomain, removeDomain, getGlobalAgent, getAgentDomain, getAgentDomains, getDomainAgents, getGlobalAgentIds, clearRegistry } from "./config/registry.js";
...
export { startConfigWatcher, stopConfigWatcher, loadConfigSnapshot, diffConfigs, diffDomainConfigs } from "./config/watcher.js";
export {
...
export { createClawforceEntityTool } from "./tools/entity-tool.js";
...
export { createProposal } from "./approval/resolve.js";
...
export { listEntityCheckRuns, runEntityChecks } from "./entities/checks.js";
export {
  loadEntityManifest,
  normalizeEntityManifest,
